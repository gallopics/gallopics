...
const EventProfile       = lazy(() => import('./pages/EventProfile').then(m => ({ default: m.EventProfile })));
const PhotographerProfile = lazy(() => import('./pages/PhotographerProfile').then(m => ({ default: m.PhotographerProfile })));
const RiderProfile       = lazy(() => import('./pages/RiderProfile').then(m => ({ default: m.RiderProfile })));
...
const EventDetail        = lazy(() => import('./pages/pg/EventDetail').then(m => ({ default: m.EventDetail })));
const SoldPhotos         = lazy(() => import('./pages/pg/SoldPhotos').then(m => ({ default: m.SoldPhotos })));
const Receipts           = lazy(() => import('./pages/pg/Receipts').then(m => ({ default: m.Receipts })));
const PhotographerBilling = lazy(() => import('./pages/pg/Billing').then(m => ({ default: m.PhotographerBilling })));
const Settings           = lazy(() => import('./pages/pg/Settings').then(m => ({ default: m.Settings })));
const TokensPage         = lazy(() => import('./pages/pg/TokensPage').then(m => ({ default: m.TokensPage })));
const UploadPage         = lazy(() => import('./pages/pg/UploadPage').then(m => ({ default: m.UploadPage })));
const Photographers      = lazy(() => import('./pages/pg/Photographers').then(m => ({ default: m.Photographers })));
