                        ...
                        <React.Fragment key={index}>
                            <div
                                className={[
                                    ...
                                    item.onClick ? 'cursor-pointer hover:text-[var(--color-text-primary)]' : '',
                                    item.active ? 'text-[var(--color-text-primary)] cursor-default' : '',
                                    // Mobile shrink behavior
                                    index === 0 ? 'max-[768px]:flex-shrink-0' : '',
                                    index > 0 && index < items.length - 1 ? 'max-[768px]:flex-[2_2_0%] max-[768px]:min-w-0' : '',
                                    index === items.length - 1 && items.length > 1 ? 'max-[768px]:flex-shrink max-[768px]:min-w-0' : '',
                                ].join(' ')}
