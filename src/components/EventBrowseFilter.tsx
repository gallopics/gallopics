...
export const EventBrowseFilter: React.FC<EventBrowseFilterProps> = ({
    ...
    return (
        <div className={`block w-full bg-transparent p-0 z-[90] ${isSticky ? 'py-3 bg-white/85 [-webkit-backdrop-filter:blur(12px)] [backdrop-filter:blur(12px)] border-b border-black/[0.06] shadow-[0_4px_20px_rgba(0,0,0,0.03)]' : ''}`}>
