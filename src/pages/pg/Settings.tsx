    ...
    return (
        <div className="w-full">
            ...
            <div className="bg-white border border-[var(--color-border)] rounded-xl p-6 max-w-[800px] mb-6 mx-auto">
                <h2 className="text-[1.1rem] font-semibold text-[var(--color-text-primary)] mt-0 mb-5 pb-4 border-b border-[var(--color-border)]">Profile & public page</h2>

                <div className="flex justify-between items-center py-4 border-b border-[var(--color-border)]">
                    <div className="flex-1 pr-6">
                        <div className="text-[0.875rem] font-medium text-[var(--color-text-primary)] mb-1">Highlight photos</div>
                        <div className="text-[0.8125rem] text-[var(--color-text-secondary)]">{highlights.length} / 10 selected</div>
                    </div>
                    <button
                ...
                <div className="flex justify-between items-center py-4">
                    <div className="flex-1 pr-6">
                        <div className="text-[0.875rem] font-medium text-[var(--color-text-primary)] mb-1">Available to hire</div>
                        <div className="text-[0.8125rem] text-[var(--color-text-secondary)]">Allow potential clients to hire you from your public profile</div>
                    </div>
                    <label className="relative inline-block w-12 h-[26px]">
                        ...
                        <span
                            ...
                            style={{ backgroundColor: availableToHire ? 'var(--color-brand-primary)' : 'var(--color-border)' }}
                        >
                            <span
