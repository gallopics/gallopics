...
import { Search, Palette, Type, Box, LayoutTemplate, FileInput, CreditCard, ChevronRight, ChevronLeft, Upload, LayoutGrid, ShoppingBag, Settings, X } from 'lucide-react';
...
const MOCK_EVENT = {
    ...
    coverImage: 'https://images.unsplash.com/photo-1534068590799-09895a701e3e?auto=format&fit=crop&w=800&q=80',
...
export const TokensPage: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'colors' | 'typography' | 'components' | 'forms' | 'layout' | 'cards' | 'utilities'>('colors');
    ...
    return (
        <div className="tokens-page">
            ...
            <div className="bg-white border-b border-[var(--color-border)] px-[5%] h-16 flex items-center gap-3 mb-10">
                <span className="text-[1.25rem] font-extrabold text-primary">Settings</span>
            ...
            <div className="container">
                <div className="tokens-tabs-scroll">
                    <div className="tokens-tabs">
                        <button className={`tokens-tab-btn ${activeTab === 'colors' ? 'active' : ''}`} onClick={() => setActiveTab('colors')}>
                            <Palette size={18} /> Colors
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'typography' ? 'active' : ''}`} onClick={() => setActiveTab('typography')}>
                            <Type size={18} /> Typography
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'components' ? 'active' : ''}`} onClick={() => setActiveTab('components')}>
                            <Box size={18} /> Components
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'forms' ? 'active' : ''}`} onClick={() => setActiveTab('forms')}>
                            <FileInput size={18} /> Forms
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'layout' ? 'active' : ''}`} onClick={() => setActiveTab('layout')}>
                            <LayoutTemplate size={18} /> Layout
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'cards' ? 'active' : ''}`} onClick={() => setActiveTab('cards')}>
                            <CreditCard size={18} /> Cards
                        </button>
                        <button className={`tokens-tab-btn ${activeTab === 'utilities' ? 'active' : ''}`} onClick={() => setActiveTab('utilities')}>
                    ...
                    {activeTab === 'colors' && (
                        <div className="tokens-section">
                            ...
                            <div className="color-grid">
                                <ColorSwatch name="Background" variable="--color-bg" value="#F9FAFB" />
                                <ColorSwatch name="Surface" variable="--color-surface" value="#FFFFFF" />
                                <ColorSwatch name="Text Primary" variable="--color-text-primary" value="#111111" />
                                <ColorSwatch name="Text Secondary" variable="--color-text-secondary" value="#666666" />
                                <ColorSwatch name="Border" variable="--color-border" value="#E5E5E5" />
                                <ColorSwatch name="Accent" variable="--color-accent" value="#000000" />
                            </div>

                            <h3>Brand Colors</h3>
                            <div className="color-grid">
                                <ColorSwatch name="Brand Primary" variable="--color-brand-primary" value="#1B3AEC" />
                                <ColorSwatch name="Brand Hover" variable="--color-brand-primary-hover" value="#152DBB" />
                                <ColorSwatch name="Brand Tint" variable="--color-brand-tint" value="rgba(27, 58, 236, 0.08)" />
                                <ColorSwatch name="Brand Tint Strong" variable="--color-brand-tint-strong" value="rgba(27, 58, 236, 0.12)" />
                            </div>

                            <h3>Shadows & Elevations</h3>
                            <div className="elevation-grid">
                                <div className="elevation-card">
                                    <div className="elevation-box elevation-box--sm">
                                        SM
                                    </div>
                    ...
                    {activeTab === 'typography' && (
                        <div className="tokens-section">
                            ...
                            <div className="typo-list">
                                <TypoItem label="Display" size="3rem" weight="800" variable="--fs-display" />
                                <TypoItem label="H1 (3XL)" size="2rem" weight="800" variable="--fs-3xl" />
                                <TypoItem label="H2 (2XL)" size="1.5rem" weight="700" variable="--fs-2xl" />
                                <TypoItem label="Large" size="1.125rem" weight="400" variable="--fs-lg" />
                                <TypoItem label="Base" size="1rem" weight="400" variable="--fs-base" />
                                <TypoItem label="Small" size="0.875rem" weight="400" variable="--fs-sm" />
                                <TypoItem label="Extra Small" size="0.75rem" weight="500" variable="--fs-xs" />
                            </div>
                        </div>
                    )}
                                    ...
                                    <div className="comp-col w-auto">
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <TokenShowcase label='shape="circle" size="medium"'>
                                                <Button shape="circle" size="medium" variant="ghost" icon={<Search size={20} />} />
                                            </TokenShowcase>
                                            <TokenShowcase label='shape="circle" size="floating"'>
                                                <div className="flex gap-3">
                                                    <Button shape="circle" size="floating" variant="white" icon={<Upload size={20} />} title="White Variant" />
                                                    <Button shape="circle" size="floating" variant="primary" icon={<Upload size={20} />} title="Primary Blue Variant" />
                                                </div>
                                            </TokenShowcase>
                                            <TokenShowcase label='shape="circle" size="large"'>
                                                <Button shape="circle" size="large" variant="primary" icon={<Upload size={24} />} />
                                            </TokenShowcase>
                                        </div>
                                    </div>
                                    ...
                                    <div className="comp-col w-auto">
                                        ...
                                        <div className="flex gap-4 items-center">
                                            <TokenShowcase label="size={36}">
                                                <ProfileAvatar size={36} url="https://ui-avatars.com/api/?name=U&background=random" />
                                            </TokenShowcase>
                                            <TokenShowcase label='size={48} variant="photographer"'>
                                                <ProfileAvatar size={48} variant="photographer" url="https://ui-avatars.com/api/?name=P&background=random" />
                                            </TokenShowcase>
                                            <TokenShowcase label="size={80}">
                                                <ProfileAvatar size={80} url="https://ui-avatars.com/api/?name=XL&background=random" />
                                            </TokenShowcase>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="comp-row">
                                    <TokenShowcase label="User Profile Pill (Header Context)">
                                        <button className="user-chip">
                                            <div className="user-avatar-circle bg-[var(--color-text-primary)]">
                                                <img src="https://ui-avatars.com/api/?name=Klara+Fors&background=333&color=fff" alt="" className="w-full h-full rounded-full object-cover" />
                                            </div>
                                    ...
                                    <TokenShowcase label="Header Actions Group">
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <button className="share-icon-btn"><Search size={20} /></button>
                                            <button className="share-icon-btn"><ShoppingBag size={20} /></button>
                                            <button className="share-icon-btn"><LayoutGrid size={20} /></button>
                                            <div className="w-px h-6 bg-[var(--color-border)] mx-1"></div>
                                            <Button size="medium" variant="primary">Submit Photo</Button>
                                        </div>
                                    </TokenShowcase>
                                </div>
                            </div>
                            ...
                            <div className="comp-showcase">
                                <div className="comp-row">
                                    <TokenShowcase label='<InfoChip variant="rider" />'>
                                        <InfoChip label="RIDER" name="Alva Karlsson" variant="rider" onClick={() => { }} />
                                    </TokenShowcase>
                                    <TokenShowcase label='<InfoChip variant="horse" />'>
                                        <InfoChip label="HORSE" name="Göta Glimt" variant="horse" onClick={() => { }} />
                                    </TokenShowcase>
                                </div>
                                <div className="comp-row">
                                    ...
                                    <TokenShowcase label='<FilterChip badge={5} />'>
                                        <FilterChip label="Needs Review" badge={5} onClick={() => { }} />
                                    </TokenShowcase>
                                </div>
                            </div>
                                ...
                                <div className="comp-row items-start">
                                    <div className="w-[200px]">
                                        <TokenShowcase label='<ModernDropdown />'>
                                            <ModernDropdown
                                                value="all"
                                                options={[{ label: 'All Countries', value: 'all' }, { label: 'Sweden', value: 'se' }]}
                                                onChange={() => { }}
                                                label='Country'
                                                placeholder="Default"
                                            />
                                    ...
                                    <div className="w-[180px]">
                                        <TokenShowcase label='<ModernDropdown variant="pill" />'>
                                            <ModernDropdown
                                                value="all"
                                                variant="pill"
                                                options={[{ label: 'All Classes', value: 'all' }, { label: '1.10m', value: '110' }]}
                                                onChange={() => { }}
                                                label="Class"
                                            />
                                        </TokenShowcase>
                                ...
                                <div className="comp-col max-w-[400px]">
                                    <TokenShowcase label='class="token-input" (Standard)'>
                                        <div className="token-form-group">
                                            ...
                                            <input type="email" className="token-input" placeholder="name@example.com" />
                                        </div>
                                    </TokenShowcase>
                                    <TokenShowcase label='class="token-input error"'>
                                        <div className="token-form-group">
                                            <label className="token-label">Error State</label>
                                            <input type="text" className="token-input error" defaultValue="Invalid input" />
                                            <span className="token-error-msg">This field is required</span>
                                        </div>
                                    </TokenShowcase>
                                </div>
                            </div>
                            ...
                            <div className="comp-showcase bg-[var(--ui-bg-subtle)] p-0">
                                <TokenShowcase label="PhotographerLayout Sidebar">
                                    <div className="mock-sidebar-container">
                                        <aside className={`mock-sidebar ${mockSidebarCollapsed ? 'collapsed' : ''}`}>
                                            <div className="mock-sidebar-header">
                                                {!mockSidebarCollapsed && <span className="mock-sidebar-label">Workspace</span>}
                                                <button className="mock-collapse-btn" onClick={() => setMockSidebarCollapsed(!mockSidebarCollapsed)}>
                                                    {mockSidebarCollapsed ? <ChevronRight size={14} /> : <ChevronLeft size={14} />}
                                                </button>
                                            </div>
                            ...
                            <div className="comp-showcase bg-[var(--color-text-primary)] p-10 flex justify-center">
                                <TokenShowcase label="<AuthModal /> Structure" darkBg>
                                    <div className="mock-modal">
                                        <button className="mock-modal-close"><X size={20} /></button>
                                ...
                                <div className="comp-row">
                                    <TokenShowcase label="Breadcrumbs Pattern">
                                        <div className="flex gap-2 items-center text-secondary text-[0.875rem]">
                                            ...
                                            <span>Gallery</span>
                                            <ChevronRight size={14} />
                                            <span className="text-primary font-medium">Summer Cup</span>
                                        </div>
                                    </TokenShowcase>
                                </div>
                                <div className="comp-row">
                                    <TokenShowcase label="Empty State Message">
                                        <div className="text-center p-6">
                                            <div className="text-[1.2rem] font-semibold mb-2">No photos found</div>
                                            <div className="text-secondary text-[0.875rem]">Try adjusting your filters</div>
                                        </div>
                                    </TokenShowcase>
                                </div>
                            </div>
...
const TokenShowcase: React.FC<{ label: string; children: React.ReactNode; darkBg?: boolean }> = ({ label, children, darkBg }) => (
    <div className="token-showcase-item">
        <div className="token-showcase-render">
            {children}
        </div>
...
const ColorSwatch: React.FC<{ name: string; variable: string; value: string }> = ({ name, variable, value }) => (
    <div className="color-swatch">
        <div className="swatch-box" style={{ backgroundColor: value, border: value === '#FFFFFF' ? '1px solid var(--color-border)' : 'none' }}></div>
...
const TypoItem: React.FC<{ label: string; size: string; weight: string; variable: string }> = ({ label, size, weight, variable }) => (
