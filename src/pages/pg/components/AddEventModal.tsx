...
export const AddEventModal: React.FC<AddEventModalProps> = ({ isOpen, onClose, eventToEdit }) => {
    ...
    useEffect(() => {
        if (isOpen && eventToEdit) {
            ...
            setSelectedPhotographers(eventToEdit.assignedPhotographers?.map((p: any) => p.id) || []);
    ...
    const cityOptions = country === 'Sweden' ? [
        { label: 'Stockholm', value: 'Stockholm' },
        ...
        <div className="auth-modal-overlay items-center z-[1200]" onClick={onClose}>
            ...
            >
                ...
                <div className="modal-header-standard">
                    <h2 className="edit-profile-title">{isEditMode ? 'Edit event' : 'Add an event'}</h2>
